...
export default function Home(){
  ...
  if(screen==="chapterMap"&&profile)return(
  ...
  if(screen==="blank1"&&profile)return <main style={{display:"flex",flexDirection:"column",minHeight:"100dvh",background:"var(--bg)",overflowY:"auto"}}><header className="missionNav missionNavTrust"><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> IL QUEST</div>{renderTrustBar()}<button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><section style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px",padding:"24px 0 40px",width:"100%"}}><div style={{position:"relative",width:"95%",maxWidth:"1400px"}}><img src="./slide-education-1.png" alt="Education slide 1" style={{width:"100%",borderRadius:"10px",boxShadow:"0 4px 32px rgba(0,0,0,.5)",display:"block"}}/></div><div style={{display:"flex",alignItems:"center",gap:"20px",marginTop:"8px"}}><button className="introBackBtn" onClick={()=>setScreen("questIntro")}>← {language==="it"?"Indietro":"Back"}</button><button style={{background:"#1a56db",color:"#fff",border:"none",borderRadius:"8px",padding:"14px 36px",fontWeight:700,cursor:"pointer",fontSize:"16px",letterSpacing:".04em"}} onClick={()=>{setP10SlideIdx(0);setScreen("p10Slideshow");}}>▶ {language==="it"?"Presentazione IT":"Presentation IT"}</button><button style={{background:"#0f3460",color:"#fff",border:"none",borderRadius:"8px",padding:"14px 36px",fontWeight:700,cursor:"pointer",fontSize:"16px",letterSpacing:".04em"}} onClick={()=>{setP10SlideIdx(0);setLanguage("en");setScreen("p10Slideshow");}}>▶ Presentation EN</button><button className="actionButton approachIntroCta" onClick={()=>setScreen("approachIntro")}>{language==="it"?"Avanti":"Next"} <b>→</b></button></div></section></main>;

  if(screen==="p10Slideshow"&&profile)return <main style={{background:"#000",display:"grid",gridTemplateRows:"auto 1fr auto",height:"100dvh",overflow:"hidden"}}><header style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 20px",background:"rgba(0,0,0,.85)",zIndex:10}}><button className="brand brandButton" onClick={reset} style={{color:"#fff"}}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><span style={{color:"#aaa",fontSize:"13px"}}>{p10SlideIdx+1} / {P10_SLIDES.length}</span><button className="langMini" onClick={()=>setScreen("blank1")} style={{background:"transparent",border:"1px solid #555",color:"#ccc",borderRadius:"4px",padding:"4px 10px",cursor:"pointer"}}>✕ {language==="it"?"Chiudi":"Close"}</button></header><section style={{display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",background:"#000"}}><img src={P10_SLIDES[p10SlideIdx]} alt={`Slide ${p10SlideIdx+1}`} style={{maxWidth:"90%",maxHeight:"90%",width:"90%",objectFit:"contain"}}/></section><footer style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"24px",padding:"12px 20px",background:"rgba(0,0,0,.85)"}}><button onClick={()=>setP10SlideIdx(i=>Math.max(0,i-1))} disabled={p10SlideIdx===0} style={{background:"transparent",border:"none",cursor:p10SlideIdx===0?"not-allowed":"pointer",opacity:p10SlideIdx===0?0.2:1}}><svg width="36" height="54" viewBox="0 0 36 54"><polygon points="34,2 2,27 34,52" fill="white"/></svg></button><div style={{display:"flex",gap:"6px"}}>{P10_SLIDES.map((_,i)=><span key={i} onClick={()=>setP10SlideIdx(i)} style={{width:"8px",height:"8px",borderRadius:"50%",background:i===p10SlideIdx?"#39efb4":"#555",cursor:"pointer",display:"inline-block"}}/>)}</div><button onClick={()=>p10SlideIdx===P10_SLIDES.length-1?setScreen("blank1"):setP10SlideIdx(i=>i+1)} style={{background:"transparent",border:"none",cursor:"pointer"}}><svg width="36" height="54" viewBox="0 0 36 54"><polygon points="2,2 34,27 2,52" fill="white"/></svg></button></footer></main>;
  ...
  if(screen==="challengeSeparator2"&&profile){const isIt=language==="it";return <main style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#07110e",position:"relative"}}><header className="missionNav" style={{position:"fixed",top:0,left:0,right:0}}><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> SFIDE</div><button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><h1 style={{fontSize:"clamp(72px,12vw,160px)",fontWeight:800,letterSpacing:"-.04em",color:"#f2fff9",margin:0,lineHeight:1}}>{isIt?"Sfida 2":"Challenge 2"}</h1><div style={{width:"min(340px,80vw)",margin:"36px auto 0"}}>{renderTrustBar()}</div><div style={{display:"flex",gap:"12px",marginTop:"32px"}}><button className="secondaryAction" onClick={()=>goBack()}>← {isIt?"Indietro":"Back"}</button><button className="secondaryAction" onClick={()=>setScreen("chapterMap")}>⌂ {isIt?"Indice":"Index"}</button><button className="actionButton" style={{marginTop:0}} onClick={()=>setScreen("missionCard2")}>{isIt?"Avanti →":"Next →"}</button></div></main>;}
  ...
  if(screen==="challengeSeparator3"&&profile){const isIt=language==="it";return <main style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#07110e",position:"relative"}}><header className="missionNav" style={{position:"fixed",top:0,left:0,right:0}}><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> SFIDE</div><button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><h1 style={{fontSize:"clamp(72px,12vw,160px)",fontWeight:800,letterSpacing:"-.04em",color:"#f2fff9",margin:0,lineHeight:1}}>{isIt?"Sfida 3":"Challenge 3"}</h1><div style={{width:"min(340px,80vw)",margin:"36px auto 0"}}>{renderTrustBar()}</div><div style={{display:"flex",gap:"12px",marginTop:"32px"}}><button className="secondaryAction" onClick={()=>goBack()}>← {isIt?"Indietro":"Back"}</button><button className="secondaryAction" onClick={()=>setScreen("chapterMap")}>⌂ {isIt?"Indice":"Index"}</button><button className="actionButton" style={{marginTop:0}} onClick={()=>setScreen("missionCard3")}>{isIt?"Avanti →":"Next →"}</button></div></main>;}
  ...
  if(screen==="challengeSeparator4"&&profile){const isIt=language==="it";return <main style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#07110e",position:"relative"}}><header className="missionNav" style={{position:"fixed",top:0,left:0,right:0}}><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> SFIDE</div><button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><h1 style={{fontSize:"clamp(72px,12vw,160px)",fontWeight:800,letterSpacing:"-.04em",color:"#f2fff9",margin:0,lineHeight:1}}>{isIt?"Sfida 4":"Challenge 4"}</h1><div style={{width:"min(340px,80vw)",margin:"36px auto 0"}}>{renderTrustBar()}</div><div style={{display:"flex",gap:"12px",marginTop:"32px"}}><button className="secondaryAction" onClick={()=>goBack()}>← {isIt?"Indietro":"Back"}</button><button className="secondaryAction" onClick={()=>setScreen("chapterMap")}>⌂ {isIt?"Indice":"Index"}</button><button className="actionButton" style={{marginTop:0}} onClick={()=>setScreen("missionCard4")}>{isIt?"Avanti →":"Next →"}</button></div></main>;}
  ...
  if(screen==="challengeSeparator5"&&profile){const isIt=language==="it";return <main style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#07110e",position:"relative"}}><header className="missionNav" style={{position:"fixed",top:0,left:0,right:0}}><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> SFIDE</div><button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><h1 style={{fontSize:"clamp(72px,12vw,160px)",fontWeight:800,letterSpacing:"-.04em",color:"#f2fff9",margin:0,lineHeight:1}}>{isIt?"Sfida 5":"Challenge 5"}</h1><div style={{width:"min(340px,80vw)",margin:"36px auto 0"}}>{renderTrustBar()}</div><div style={{display:"flex",gap:"12px",marginTop:"32px"}}><button className="secondaryAction" onClick={()=>goBack()}>← {isIt?"Indietro":"Back"}</button><button className="secondaryAction" onClick={()=>setScreen("chapterMap")}>⌂ {isIt?"Indice":"Index"}</button><button className="actionButton" style={{marginTop:0}} onClick={()=>setScreen("missionCard5")}>{isIt?"Avanti →":"Next →"}</button></div></main>;}
  ...
  if(screen==="challengeSeparator6"&&profile){const isIt=language==="it";return <main style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#07110e",position:"relative"}}><header className="missionNav" style={{position:"fixed",top:0,left:0,right:0}}><button className="brand brandButton" onClick={reset}><span className="brandMark">e·</span><span>Envizi<br/>Impact Quest</span></button><div className="missionProgress"><span className="activeDot"/> SFIDE</div><button className="langMini" onClick={()=>setLanguage(language==="it"?"en":"it")}>{language==="it"?"EN":"IT"}</button></header><h1 style={{fontSize:"clamp(72px,12vw,160px)",fontWeight:800,letterSpacing:"-.04em",color:"#f2fff9",margin:0,lineHeight:1}}>{isIt?"Sfida 6":"Challenge 6"}</h1><div style={{width:"min(340px,80vw)",margin:"36px auto 0"}}>{renderTrustBar()}</div><div style={{display:"flex",gap:"12px",marginTop:"32px"}}><button className="secondaryAction" onClick={()=>goBack()}>← {isIt?"Indietro":"Back"}</button><button className="secondaryAction" onClick={()=>setScreen("chapterMap")}>⌂ {isIt?"Indice":"Index"}</button><button className="actionButton" style={{marginTop:0}} onClick={()=>setScreen("missionCard6")}>{isIt?"Avanti →":"Next →"}</button></div></main>;}
