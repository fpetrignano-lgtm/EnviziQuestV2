...
import { ChallengeSeparator1, ChallengeSeparator2, ChallengeSeparator3, ChallengeSeparator4, ChallengeSeparator5, ChallengeSeparator6, ChallengeComplete1, ChallengeComplete2, ChallengeComplete3, ChallengeComplete4, ChallengeComplete5, ChallengeComplete6 } from "./screens/ChallengeScreens";
...
export default function Home(){
  ...
  const needIdToCapability:Record<string,{it:string,en:string}>={
    ...
    "reputation-6":{it:"PowerReports personalizzabili su dataset mensili e survey ESG",                                                    en:"Customisable PowerReports on monthly datasets and ESG surveys"},
  ...
  const start=()=>{if(!profile)return;localStorage.setItem("envizi-quest-profile",JSON.stringify({language,profile}));setScreen("blank1")};
  ...
  if(screen==="chapterMap"&&profile)return <ChapterMap language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar} name={name}/>;
  ...
  if(screen==="challengeSeparator1"&&profile)return <ChallengeSeparator1 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
  ...
  if(screen==="thankYou"&&profile)return <ThankYouScreen language={language} setLanguage={setLanguage} reset={reset} renderTrustBar={renderTrustBar} t={t}/>;
  ...
  if(screen==="challengeSeparator2"&&profile)return <ChallengeSeparator2 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
  ...
  if(screen==="challengeSeparator3"&&profile)return <ChallengeSeparator3 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
  ...
  if(screen==="challengeSeparator4"&&profile)return <ChallengeSeparator4 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
  ...
  if(screen==="challengeSeparator5"&&profile)return <ChallengeSeparator5 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
  ...
  if(screen==="challengeSeparator6"&&profile)return <ChallengeSeparator6 language={language} profile={profile} setLanguage={setLanguage} setScreen={setScreen} reset={reset} goBack={goBack} renderTrustBar={renderTrustBar}/>;
