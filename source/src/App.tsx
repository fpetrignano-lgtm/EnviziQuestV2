...
export default function Home(){
  ...
  const saveQuest=(name:string)=>{if(!name.trim())return;const data={userName,language,profile,priorities,prioExperience,missionOrder,missionOutcomes,missionParameters,trustScore,companyName,companySector,companyDims,companyMarket,esgReadiness,asIsRatings,dataNeeds,screen,companyLogo,workshopDate,consultantName,siteTable};localStorage.setItem(`envizi-quest-save-${name.trim()}`,JSON.stringify(data));};
